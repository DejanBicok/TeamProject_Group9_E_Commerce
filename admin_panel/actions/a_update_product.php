...
if ($_POST) {
    ...
    $picture = file_upload($_FILES['picture'], 'noimage'); 
        ...
        $sql = "UPDATE products SET name = '$name', picture = '$picture->fileName' ,price = $price, description = '$description', type = '$type', availability=$availability, displ='$displ', Discount='$discount' WHERE id = {$id}"; 
